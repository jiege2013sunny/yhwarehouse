...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "5Gnx8gifzdFVYQyh4VGLHYen95votxsiFhysJpGp";
    private static final String SECRETKEY = "2EQS5I2t1uTOIOOpPNFFyPZ4wbnctHFGljLinN_a";
    private static final String BUCKET = "yhzspicture";
    public static final String DOMAIN= "http://qmlviu6q0.hn-bkt.clouddn.com/";
